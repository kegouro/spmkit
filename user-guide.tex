...
{\normalsize
  \textbf{Authors:} Jos\'e Labarca \& Tom\'as Corrales\\
  \textbf{License:} MIT\\
...
SPM-Kit was developed independently by physics students at Universidad T\'ecnica Federico Santa Mar\'ia (UTFSM), informed by practical work with AFM/SPM data, and is released under the MIT license.
...
\begin{lstlisting}[language=bash]
@software{spmkit2026,
  author       = {Jos\'e Labarca and Tom\'as Corrales},
