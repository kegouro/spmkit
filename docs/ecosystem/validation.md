...
<section class="spm-component" data-component="validation">
  ...
  <div class="spm-component__body">
    ...
    <div><span class="spm-status">Alpha · source 0.1.0</span><div class="spm-io"><span><b>Input</b>campaign, SUT, reference, tolerance</span><span aria-hidden="true">→</span><span><b>Output</b>records, reports, blockers, audit trail</span></div></div>
  </div>
</section>
